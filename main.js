...
const API_KEY = "fc2c1bbdca21eb4d1a102bb210952903";
...
const getHourlyForeCast = async ({ name : city}) => {
    ...
    let newArr =  data.list.map(forecast=>{
...
loadHourlyForecast = ({main: {temp: tempNow},weather:[{icon:iconNow}]},hourlyForecast) => { 
